var Base = {
    ...
    setZoomValue: function () {
        ...
        var n = $(window).height() / deviceHeight;
        var l = $(window).width() / deviceWidth;
        ...
        if (w == 768) {
            ...
            switch (curPage.name) {
                case enumPageInfo.landing.name:
                    p <= deviceRatio ? $(".landing").css({ "margin-top": ($(window).height() / n - 480) / 2, "box-shadow": "none" }) : $(".landing").css({ "margin-top": ($(window).height() / l - 480) / 2, "box-shadow": "none" });  //Calculate the margin-top of the 'main' area  /* Update By Jean On 27/10/2014 */
                    break;
                case enumPageInfo.emergencyInstructions.name:
                    p <= deviceRatio ? $(".media").css({ "margin-top": ($(window).height() / n - 480) / 2, "box-shadow": "none" }) : $(".media").css({ "margin-top": ($(window).height() / l - 480) / 2, "box-shadow": "none" });  //Calculate the margin-top of the 'media' area  /* Update By Jean On 27/10/2014 */
                ...
                case enumPageInfo.injectionStepGuide.name:
                    p <= deviceRatio ? $(".injection_step_guide").css("margin-top", ($(window).height() / n - 480) / 2) : $(".injection_step_guide").css("margin-top", ($(window).height() / l - 480) / 2);  //Calculate the margin-top of the 'injection_step_guide' area  /* Update By Jean On 27/10/2014 */
                    break;
                case enumPageInfo.injectionStep01.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_1 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_1 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep02.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_2 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_2 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                ...
                case enumPageInfo.injectionStep07.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_7 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_7 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep08.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_8 .btn_next").css({ "right": ($(window).width() / n - 210) / 2, "top": parseInt($(".injection_step_8 .btn_next").css("top")) + parseInt(($(window).height() / n - 480) / 2 + 10) }) : $(".injection_step_8 .btn_next").css({ "right": ($(window).width() / l - 210) / 2, "top": parseInt($(".injection_step_8 .btn_next").css("top")) + parseInt(($(window).height() / l - 480) / 2 + 10) });  //Calculate how far to the right and top for the 'btn_next' button  /* Update By Jean On 28/10/2014 */
                    p <= deviceRatio ? $(".injection_step_8 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_8 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10)  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                ...
                case enumPageInfo.injectionStep11.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_11 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_11 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep12.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_12 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_12 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep13.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_13 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_13 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep14.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_14 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_14 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                case enumPageInfo.injectionStep15.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".injection_step_15 .tips").css("margin-top", ($(window).height() / n - 480) / 2 + 10) : $(".injection_step_15 .tips").css("margin-top", ($(window).height() / l - 480) / 2 + 10);  //Calculate the margin-top of the 'tips' area  /* Update By Jean On 28/10/2014 */
                    break;
                ...
                case enumPageInfo.myKitInformation.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 50) : $(".fixed_height").height($(window).height() / l - 50);  // Calculate the height of the main area
                    p <= deviceRatio ? $(".kit_list").css("max-height", $(window).height() / n - 350) : $(".kit_list").css("max-height", $(window).height() / l - 350);  // Calculate the height of the 'kit_list' area
                    break;
                case enumPageInfo.informationForUser.name:
                    //p <= deviceRatio ? $(".fixed_height_pdf").height($(window).height() / n - 50) : $(".fixed_height_pdf").height($(window).height() / l - 50);  // Calculate the height of the 'pdf_wrap' area
                    break;
                case enumPageInfo.informationForPhysician.name:
                    //p <= deviceRatio ? $(".fixed_height_pdf").height($(window).height() / n - 50) : $(".fixed_height_pdf").height($(window).height() / l - 50);  // Calculate the height of the 'pdf_wrap' area
                    break;
                case enumPageInfo.overview.name:
                    p <= deviceRatio ? $(".fixed_height").height($(window).height() / n - 40) : $(".fixed_height").height($(window).height() / l - 40);  // Calculate the height of the 'main' area
                    break;
            }
        }
    },
