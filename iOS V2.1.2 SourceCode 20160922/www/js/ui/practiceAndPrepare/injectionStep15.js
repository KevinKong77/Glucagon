Ext.define(enumPageInfo.injectionStep15.nameSpace, {
    alias: [enumPageInfo.injectionStep15.nameSpace],
    config: {
        mainPanel: null
    },
    name: enumPageInfo.injectionStep15.name,
    isPainted: false,
    isCorrect: false,
    ...
    createPanel: function () {
        ...
        try {
            mainPanel = Ext.create('Ext.Container', {
                ...
                hidden: true,
                html: '<div class="main">' +
                           '<div class="injection_step injection_step_15 fixed_height">' +
                                ...
                                '<div class="hand_2" id="div_' + me.name + '_Hand">' +
                                    '<img src="img/vp_cottonSwab.png" height="202" alt=""/>' +
                                '</div>' +
                                '<div class="tips" id="div_' + me.name + '_Tips">' +
                                  '<p id="p_' + me.name + '_Tips">Press an alcohol swab against the injection site</p>' +
                                  '<p id="p_' + me.name + '_CorrectTips">Correct!</p>' +
                                '</div>' +
                                '<div class="act_btn">' +
        ...
        try {
            if (me.isCorrect) {
                ...
                window.setTimeout(function () {
                    Base.gotoPage(enumPageInfo.injectionStepCompleted);
                }, 1000);
            }
            else {
                $('#div_' + me.name + '_Tips').css('visibility', 'visible');
