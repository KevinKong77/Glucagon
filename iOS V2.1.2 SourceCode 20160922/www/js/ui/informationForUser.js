Ext.define(enumPageInfo.informationForUser.nameSpace, {
    alias: [enumPageInfo.informationForUser.nameSpace],
    config: {
        mainPanel: null
    },
    name: enumPageInfo.informationForUser.name,
    isPainted: false,
            ...
            mainPanel = Ext.create('Ext.Container', {
                ...
                listeners: {
                    painted: function (sender, eOpts) {
                        ...
                        if (!Base.isBack) {
                            dplPDFManager.getPDFFiles(appConfig.downloadConfig.dplPDFData.ppiFolderName, function (htmlFilePath) {
                                document.getElementById('frm_' + me.name).src = htmlFilePath + '#ppi';
